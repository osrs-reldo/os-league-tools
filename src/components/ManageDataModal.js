                ...
                <ModalWrapper isOpen={isOpen} setIsOpen={setIsOpen} headerText='Tasks Tracker RuneLite Plugin'>
                    <Modal.Body className='text-primary text-sm'>
                        ...
                        <p className='m-2 mt-1'>
                            OS League Tools has RuneLite integration! Enable the plugin to sync your tasks and quest
                            (and soon, relics and unlocks too).
                        </p>
                        <Separator className='mb-2' />
        ...
        <>
            <div className='m-2 mt-1'>
                ...
                <ol className='list-decimal list-inside ml-2'>
                    ...
                    <li>
                        Click the book icon on the sidebar to open the task tracker panel, and click the Export button
                    </li>
...
function ExportToPluginContent() {
    ...
    return (
        <>
            <p className='m-2 mt-1'>
                Click on the text box below to copy your task data, then paste it into the Task Tracker plugin's import
                menu to sync your to-do list to the client.
            </p>
            <p className='m-2 mt-1'>
                <textarea
